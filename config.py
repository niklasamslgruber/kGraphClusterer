...
available_methods = [AnonymizationType.SaNGreeA.name, AnonymizationType.DISCERNIBILITY_ALL.name, AnonymizationType.DISCERNIBILITY.name, AnonymizationType.PRECISION.name]
