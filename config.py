...
available_methods = [AnonymizationType.SaNGreeA.name, AnonymizationType.DISCERNIBILITY.name, AnonymizationType.PRECISION.name, AnonymizationType.CLASSIFICATION_METRIC.name]
